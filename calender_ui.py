...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1400, 900)  # 창 크기를 더 크게 조정
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.calendarWidget = QtWidgets.QCalendarWidget(self.centralwidget)
        self.calendarWidget.setGeometry(QtCore.QRect(150, 100, 900, 600))  # 크기를 더 크게 조정
        self.calendarWidget.setObjectName("calendarWidget")
        self.graphicsView = QtWidgets.QGraphicsView(self.centralwidget)
        self.graphicsView.setGeometry(QtCore.QRect(150, 0, 150, 100))  # 크기를 더 크게 조정
        self.graphicsView.setObjectName("graphicsView")
        self.scrollArea = QtWidgets.QScrollArea(self.centralwidget)
        self.scrollArea.setGeometry(QtCore.QRect(150, 720, 900, 150))  # 크기를 더 크게 조정
        ...
        self.uncheckedTodoListWidget.setGeometry(QtCore.QRect(1100, 100, 250, 600))  # 위치 및 크기 조정
        self.uncheckedTodoListWidget.setObjectName("uncheckedTodoListWidget")

        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1400, 21))  # 창 크기에 맞게 조정
